...
\begin{proposition}
The AIC-weighted model average $\hat{g}$ converges to $g_p$ as $n \to \infty$. In other words, given enough data, we can correctly estimate which model is closest to truth.
\end{proposition}
...
In the context of SteinÕs Unbiased Risk Estimation (SURE), the degrees of freedom are given by 
\begin{equation*}
...
\begin{proposition}
The bandwidth $\hat{h}$ that minimizes the profile AIC is a ÒgoodÓ estimate of the KL-optimal bandwidth.
\end{proposition}
